...
class DepthLlavaLlamaForCausalLM(LlavaLlamaForCausalLM):
    ...
    def __init__(self, config):
        ...
        #     nn.Linear(input_channels * 336 * 336, 512),
        #     nn.ReLU(),
        #     nn.Linear(512, output_channels * 336 * 336)) 
...
def train():
    ...
    # torch.save(model.concat_mlp.state_dict(), os.path.join(training_args.output_dir, 'mlp_model.pth'))
    torch.save(model.fc1.state_dict(), os.path.join(training_args.output_dir, 'fc1_model.pth'))
    torch.save(model.fc2.state_dict(), os.path.join(training_args.output_dir, 'fc2_model.pth'))
