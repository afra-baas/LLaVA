...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images, depth_images=None):
        ...
        # depth_features=depth_features.expand(-1, image_features.size(1), -1)  
        print('shapes', image_features.shape, depth_features.shape)
        ...
        # depth_features = depth_features.unsqueeze(1)#.expand(-1, image_features.size(1), -1)
        # print('shapes', image_features.shape, depth_features.shape)
        # image_features = self.fusion_module(image_features, depth_features)
