...
from llava.model.language_model.llava_llama_dino_late import LlavaLlamaForCausalLM, AutoModelForCausalLM, LlavaConfig
from llava.train.train_for_dino_late import *
...
class DepthLlavaLlamaForCausalLM(LlavaLlamaForCausalLM):
    ...
    def __init__(self, config): #, device=None -> error: TypeError: Object of type device is not JSON serializable  
        ...
        # print('DepthLlavaLlamaForCausalLM dino late')
    ...
    def generate(
        ...
        **kwargs,
        ...
        # print("DepthLlavaLlamaForCausalLM generate dino late ")
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=None, inputs_embeds=None, **kwargs):
        # print("prepare_inputs_for_generation dino late")
...
def train():
    ...
    if model_args.vision_tower is not None:
        ...
        if training_args.freeze_mm_mlp_adapter:
            print('komt hier bij freeze_mm_mlp_adapter')
            for p in model.get_model().mm_projector.parameters():
        ...
        file = "/project/train_custom_dino_late_all_requires_grad.txt"
