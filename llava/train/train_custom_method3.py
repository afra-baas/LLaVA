...
class DepthLlavaLlamaForCausalLM(LlavaLlamaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.fusion_layer = torch.nn.Linear(8192, 4096).to(self.device).to(torch.bfloat16)
...
def train():
    ...
    torch.save(model.fusion_layer.state_dict(), os.path.join(training_args.output_dir, 'fusion_layer.pth'))
