...
from llava.model.language_model.llava_llama_late import LlavaLlamaForCausalLM, AutoModelForCausalLM, LlavaConfig
from llava.train.train_for_late import *
...
class DepthLlavaLlamaForCausalLM(LlavaLlamaForCausalLM):
    ...
    def __init__(self, config):
        ...
        # print('DepthLlavaLlamaForCausalLM in late')
    ...
    def generate(
        ...
        **kwargs,
        ...
        # print("DepthLlavaLlamaForCausalLM generate late ")
        # print("MRO:", [cls.__name__ for cls in DepthLlavaLlamaForCausalLM.mro()])
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=None, inputs_embeds=None, **kwargs):
        # print("prepare_inputs_for_generation late")
