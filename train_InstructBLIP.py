    ...
    for epoch in range(1):
        ...
        for idx, batch in pbar: 
            ...
            if idx % save_interval == 0:
                model.save_pretrained(f"/project/msc-thesis-project/forked_repos/checkpoints/{CKPT}/epoch_{epoch}_batch_{idx}")
                model.config.save_pretrained(f"/project/msc-thesis-project/forked_repos/checkpoints/{CKPT}/epoch_{epoch}_batch_{idx}")
...
if __name__ == "__main__":
    ...
    conv_mode= "vicuna_v1"
    CKPT= "VSR_TF_epoch3-nodepth-instructblip"
    save_interval = 100
    train()
