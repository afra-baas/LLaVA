...
WANDB_MODE=offline
epochs=3
CKPT="VSR_TF_epoch3-nodepth-llava-v1.5-7b"
...
deepspeed /project/forked_repos/LLaVA/llava/train/train.py \
    ...
    --bf16 True \
    --output_dir /project/forked_repos/LLaVA/checkpoints/checkpoint-${CKPT}-lora \
