...
if [ "$dataset" = "VSR" ]; then
    ...
    CKPT="VSR2-${method}-${model}"
    # CKPT="VSR_TF-${method}-${model}"

    depth_path="vsr" 
    root="/project/msc-thesis-project/forked_repos/LLaVA/playground/data/eval/custom2/answers_folder/VSR2"
    test_file="VSR_test_classification2.json"
