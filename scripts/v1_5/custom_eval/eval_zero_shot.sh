...
# dataset="VSR_f"
# dataset="VSR_random"
# dataset="VSR_random_class4"
# dataset="VSR_class4"
# dataset="Whatsup"

# method="zeroshot"
method="zeroshot_imagebind_intermediate"

for dataset in "VSR" "VSR_f" "VSR_class4" "VSR_random" "VSR_random_class4" "Whatsup" ; do
    TF=False
    ...
    if [ "$dataset" = "VSR" ]; then
        ...
        CKPT="VSR_random_class4_${method}-${model}"

        depth_path="/project/msc-thesis-project/all_vsr_depth" 
        root="/project/msc-thesis-project/forked_repos/LLaVA/playground/data/eval/custom2/answers_folder/VSR_random_class4"
        test_file="VSR_random_test_classification4.json"


    elif [ "$dataset" = "VSR_class4" ]; then
        CKPT="VSR_class4_${method}-${model}"
        ...
        CKPT="VSR_combi_${method}-${model}"

        depth_path="vsr" 
        root="/project/msc-thesis-project/forked_repos/LLaVA/playground/data/eval/custom2/answers_folder/VSR_combi"
        test_file="VSR_test_classification_combi_shuffled.json"


    ################################## Whats Up ###################################################
    elif [ "$dataset" = "Whatsup" ]; then
        CKPT="Whatsup_${method}-${model}"
